            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-muted/50 hover:bg-muted/50">
                  ...
                  <TableHead className="bg-[#2e7d32] text-white font-bold text-center border-r min-w-[200px]">Linguistic Track</TableHead>
                  <TableHead className="bg-[#2e7d32] text-white font-bold text-center border-r min-w-[200px]">Scientific Track</TableHead>
                  <TableHead className="bg-[#1b5e20] text-white font-bold text-center min-w-[200px]">Social Science Track</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                ...
                <div className="flex items-center justify-between mb-1">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="text-[10px] max-w-[200px]">{uni.sourceVerification}</p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </div>
